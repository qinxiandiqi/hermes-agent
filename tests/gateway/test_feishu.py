...
class TestAdapterBehavior(unittest.TestCase):
    ...
    def test_build_outbound_payload_uses_post_for_markdown_table(self):
        ...
        # optimize_markdown_style appends a trailing newline after a table
        # block (rule step 3), so the md-text round-trips with one more \n
        # than the raw input — upstream's table rendering requires it.
        self.assertEqual(
